        ...
        <div className="hidden md:grid md:grid-cols-4 gap-8">
          <div>
            ...
            <div className="mt-4 flex items-center gap-4">
              ...
              <a href="https://instagram.com/vaultoAI" target="_blank" rel="noopener noreferrer" className="text-[var(--muted)] transition-colors hover:text-[var(--foreground)]" aria-label="Instagram">
