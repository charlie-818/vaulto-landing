...
export const CompanyMarquee = memo(function CompanyMarquee() {
  ...
  return (
    <div
      className="hero-marquee hidden sm:block animate-fade-in-up animation-delay-600 absolute inset-x-0 bottom-[calc(16svh+env(safe-area-inset-bottom))] sm:bottom-20 lg:bottom-24 z-10 overflow-hidden"
      style={{
        maskImage:
